...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    ...
    books: {
      ...
      resolve(parent, args) {
        // return books;
        return Book.find({}); //return all the books when the object passed is empty
      }
    },
    authors: {
...
const Mutation = new GraphQLObjectType ({
  ...
  fields: {
    addAuthor: {
      type: AuthorType,
      args: {
        name: {type: new GraphQLNonNull(GraphQLString)},//GraphQLNonNull validate adding null value 
      ...
      resolve(parent, args) {
        ...
        return author.save(); // this save is part of mongoose, use return to get back the saved data
      }
    },
    addBook: {
      type: BookType,
